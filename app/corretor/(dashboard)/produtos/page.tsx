...
import { Table2, Search, Tag } from "lucide-react"
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <div className="flex items-center gap-1 bg-green-50 px-2 py-1 rounded-md">
                          ...
                          <span className="text-green-700 font-medium">Comissão:</span>
                        </div>
                      </TooltipTrigger>
                      <TooltipContent>
                        <p>Valor ou percentual de comissão para este produto</p>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
